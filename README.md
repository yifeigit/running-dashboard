...
| 来源 | 目录 | 说明 | 时间范围 |
|---|---|---|---|
| 小米运动健康 | `tcx/` | 历史导出（.tcx，含 GPS 轨迹、步数） | 2025-02-17 ~ 2025-09-17（38 条） |
| 高驰 COROS | `fit/` | 当前数据源（.fit，文件名即 labelId） | 2025-11-15 ~ 至今（91 条） |

两个来源时间上**不重叠**，整合后共 **129 条**跑步记录，时间连续覆盖 2025-02-17 至今。
